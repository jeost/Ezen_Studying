...
<title>Insert title here</title>
	<style type="text/css">
		...
		#sub_menu h3{
			font-size:20px; color:#55cfad; background-color: #516e7f; padding:15px;
		}
		#sub_menu li{padding:10px; border-bottom: dotted 1px #dddddd;}
		#main_contents h3{font-size:20px; padding-bottom:10px; border-bottom: solid 1px #dddddd;}
		#main_contents p{
